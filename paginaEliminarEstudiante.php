    ...
    <div class="container" role="main">
        <div class="c1">
            ...
            <div class="formulario">
                <form action="bd/eliminarEstudiante.php" method="post">
                    <h3>Ingresa el id del estudiante que deseas eliminar</h3>
                    <p><label for="">Id</label></p>
                    <p><input type="text" class="input" name="id" required></p>
                    <p><input type="submit" class="button" value="Eliminar"></p>
                </form>
            </div>
